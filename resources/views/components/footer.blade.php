            ...
            <div class="mx-auto max-w-screen-md sm:text-center">
                ...
                <form action="/newsletter" method="POST">
                    ...
                    <div class="items-center mx-auto mb-3 space-y-4 max-w-screen-sm sm:flex sm:space-y-0">
                        ...
                        <div>
                            <button type="submit" class="py-3 px-5 w-full text-sm font-medium text-center text-white rounded-lg border cursor-pointer bg-blue-900 border-blue-900 sm:rounded-none sm:rounded-r-lg hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 dark:bg-blue-900 dark:hover:bg-blue-800 dark:focus:ring-blue-300">Subscribe</button>
                          </div>
                          @error('email')
