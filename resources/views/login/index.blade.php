<x-layout>
  <div class="flex items-center justify-center h-screen">
        ...
        <form action="/login" method="POST" class="bg-white shadow-md bg-gray-100 rounded px-8 pt-6 pb-8 mb-4 w-1/2">
            @csrf
            <h1 class="text-center px-5 py-5 bg-gray-100 rounded">Login</h1>
